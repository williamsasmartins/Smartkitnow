...
const pages = [
    ...
    { url: "financial/compound-interest", priority: "0.8" },
    ...
    { url: "health/bmi-body-mass-index", priority: "0.7" },
    ...
    { url: "health/bmr-mifflin-st-jeor", priority: "0.7" },
    { url: "health/body-fat-us-navy-3-sites", priority: "0.7" },
