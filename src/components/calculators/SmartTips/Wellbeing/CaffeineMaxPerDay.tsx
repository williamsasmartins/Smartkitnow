...
export default function CaffeineMaxPerDayByBodyWeight() {
  return (
    <div className="max-w-3xl mx-auto prose prose-neutral dark:prose-invert">
      <h1 className="mb-2">Caffeine Max per Day (by body weight)</h1>
      <p className="text-sm opacity-80">Category: smart-tips · Subcategory: wellbeing</p>

      <div className="mt-6 p-4 border rounded-xl">
        <h2>Calculator UI</h2>
        <p>This is a scaffold stub for <code>caffeine-max-per-day</code>. Replace with your real UI.</p>
