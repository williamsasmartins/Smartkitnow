...
export default function BirdWeightTrendAlertOwnerInput() {
  return (
    <div className="max-w-3xl mx-auto prose prose-neutral dark:prose-invert">
      <h1 className="mb-2">Bird Weight Trend &amp; Alert (owner input)</h1>
      <p className="text-sm opacity-80">Category: pets · Subcategory: birds</p>

      <div className="mt-6 p-4 border rounded-xl">
        <h2>Calculator UI</h2>
        <p>This is a scaffold stub for <code>bird-weight-trend-alert</code>. Replace with your real UI.</p>
