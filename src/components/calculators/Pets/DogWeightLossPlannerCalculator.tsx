...
export default DogWeightLossPlannerCalculator; DogCalorieNeedsRerMer() {
  ...
  function handleCalculate() {
    // No special action needed since useMemo updates automatically
  }
  ...
  return (
    <CalculatorVerticalLayout
      ...
      editorial={
        <div>
          <section id="how-it-works">
            <h2>How It Works</h2>
            <p>
              This calculator estimates your dog's daily calorie needs using two key metrics:
            </p>
            <ul>
              <li>
            ...
            <p>
              The activity factor varies depending on your dog's lifestyle, such as neutered adult, intact adult, or working dog.
            </p>
          </section>
          ...
          <section id="faq">
            ...
            <p>
              The activity factor adjusts the resting energy needs to account for your dog's daily activity level. Typical values range from 1.2 for neutered adults to 2.0 for very active or working dogs.
            </p>
            <h3>Can I use this calculator for puppies?</h3>
            <p>
              This calculator is designed for adult dogs. For puppies, please use a specialized puppy calorie needs calculator.
            </p>
          </section>
          ...
          <section id="references">
            ...
            <ul>
              ...
              <li>
                <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7149603/" target="_blank" rel="noopener noreferrer">
      ...
      example={{
        ...
        scenario: "A 15 kg adult dog with an activity factor of 1.6",
        steps: [
          {
            step: 1,
