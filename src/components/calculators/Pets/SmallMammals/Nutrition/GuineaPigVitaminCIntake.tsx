...
export default function GuineaPigVitaminCIntakeChecker() {
  return (
    <div className="max-w-3xl mx-auto prose prose-neutral dark:prose-invert">
      <h1 className="mb-2">Guinea Pig Vitamin C Intake Checker</h1>
      <p className="text-sm opacity-80">Category: pets · Subcategory: small-mammals</p>

      <div className="mt-6 p-4 border rounded-xl">
        <h2>Calculator UI</h2>
        <p>This is a scaffold stub for <code>guinea-pig-vitamin-c-intake</code>. Replace with your real UI.</p>
