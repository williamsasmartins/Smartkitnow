...
export const petsEntries: CalculatorEntry[] = [
  {
      ...
      seoTitle: "Dog RER and MER Calculator — Daily Calorie Needs",
      seoDescription:
        "Calculate your dog's resting (RER) and maintenance (MER) energy requirement by weight, with the standard MER multipliers for puppy, adult and senior.",
    ...
    },
  {
      ...
      seoTitle: "Cat Calorie Calculator — Daily RER and MER Needs",
      seoDescription:
        "Calculate your cat's resting (RER) and maintenance (MER) energy requirement by weight, with multipliers for kitten, adult, senior and neutered cats.",
    ...
    },
  {
      ...
      seoTitle: "Kitten Weight Predictor — Adult Size by Age",
      seoDescription:
        "Predict how big your kitten will grow from its current age and weight, with a growth chart covering small, medium and large cat breeds.",
