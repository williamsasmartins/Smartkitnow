...
export default function DryMatterBasisConverterDMB() {
  return (
    <div className="max-w-3xl mx-auto prose prose-neutral dark:prose-invert">
      <h1 className="mb-2">Dry Matter Basis Converter (DMB)</h1>
      <p className="text-sm opacity-80">Category: pets · Subcategory: general</p>

      <div className="mt-6 p-4 border rounded-xl">
        <h2>Calculator UI</h2>
        <p>This is a scaffold stub for <code>dry-matter-basis-converter</code>. Replace with your real UI.</p>
