    ...
    <div className="space-y-12">
      ...
      <section id="references" className="scroll-mt-32">
        ...
        <ul className="list-disc pl-5 space-y-4 text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <li>
            <a href="https://en.wikipedia.org/wiki/Special:Search?search=Shoe%20Size%20Conversion" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
              Shoe Size Conversion - Wikipedia
            </a>
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              Detailed encyclopedia article covering the history, standards, and usage of Shoe Size Conversion.
            </p>
          </li>
          <li>
            <a href="https://www.zappos.com/c/shoe-size-conversion" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
              Shoe Size Conversion - Zappos
            </a>
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              Practical Shoe Size Conversion charts and fitting guides from Zappos to ensure the perfect fit.
            </p>
          </li>
          <li>
            <a href="https://www.calculator.net/search?q=Shoe%20Size%20Conversion" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
              Shoe Size Conversion - Calculator.net
            </a>
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              Compare results and explore alternative calculation methods for Shoe Size Conversion on Calculator.net.
            </p>
          </li>
        </ul>
      </section>
