    ...
    <div className="space-y-12">
      ...
      <section id="references" className="scroll-mt-32">
        ...
        <ul className="list-disc pl-5 space-y-4 text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <li>
            <a href="https://www.fueleconomy.gov/feg/findacar.shtml" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
              Fuel Economy - FuelEconomy.gov
            </a>
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              Official fuel economy data and Fuel Economy information from the U.S. Department of Energy.
            </p>
          </li>
          <li>
            <a href="https://www.khanacademy.org/search?page_search_query=Fuel%20Economy" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
              Fuel Economy - Khan Academy
            </a>
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              Learn the math and science behind Fuel Economy with free interactive lessons and videos from Khan Academy.
            </p>
          </li>
          <li>
            <a href="https://www.calculator.net/search?q=Fuel%20Economy" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
              Fuel Economy - Calculator.net
            </a>
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              Compare results and explore alternative calculation methods for Fuel Economy on Calculator.net.
            </p>
          </li>
        </ul>
      </section>
