    ...
    <div className="space-y-12">
      ...
      <section id="references" className="scroll-mt-32">
        ...
        <ul className="list-disc pl-5 space-y-4 text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <li>
            <a href="https://www.computerhope.com/search.htm?q=Data%20Compression" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
              Data Compression - Computer Hope
            </a>
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              Clear explanations, examples, and history of Data Compression from Computer Hope's extensive tech dictionary.
            </p>
          </li>
          <li>
            <a href="https://search.techtarget.com/search/query?q=Data%20Compression" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
              Data Compression - TechTarget
            </a>
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              In-depth technical definitions and enterprise context for Data Compression from TechTarget.
            </p>
          </li>
          <li>
            <a href="https://www.calculator.net/search?q=Data%20Compression" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
              Data Compression - Calculator.net
            </a>
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              Compare results and explore alternative calculation methods for Data Compression on Calculator.net.
            </p>
          </li>
          <li>
            <a href="https://en.wikipedia.org/wiki/Special:Search?search=Data%20Compression" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
              Data Compression - Wikipedia
            </a>
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              Detailed encyclopedia article covering the history, standards, and usage of Data Compression.
            </p>
          </li>
        </ul>
      </section>
