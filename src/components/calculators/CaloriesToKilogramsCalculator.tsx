  ...
  return <div className="min-h-screen p-4">
      ...
      <Card className="max-w-3xl mx-auto dark:bg-gray-800 bg-white dark:border-gray-700 border-gray-200">
        ...
        <CardContent className="p-6 space-y-6">
          {error && <Alert variant="destructive" className="dark:border-red-800 border-red-200 dark:bg-red-900/50 bg-red-100">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input id="calories" type="number" placeholder="Ex: 3500" value={calories} onChange={e => setCalories(e.target.value === "" ? "" : Number(e.target.value))} min="0" step="1" className="w-full dark:bg-gray-700 bg-white dark:border-gray-600 border-gray-300 dark:text-white text-gray-900 dark:placeholder-gray-500 placeholder-gray-400" />
          ...
          <div className="flex gap-3">
            <Button onClick={calculateCaloriesToKg} disabled={!calories || !activityLevel || loading} className="flex-1 dark:bg-blue-600 bg-blue-500 dark:text-white text-white dark:hover:bg-blue-700 hover:bg-blue-600">
              {loading ? <>Calculating...</> : <><Calculator className="h-4 w-4 mr-2 dark:text-blue-400 text-blue-600" />Calculate</>}
            </Button>
            {(calories || activityLevel) && <Button variant="outline" onClick={resetCalculator} className="flex-0 dark:text-white text-gray-900 dark:border-gray-600 border-gray-300 dark:hover:bg-gray-700 hover:bg-gray-100">
                Reset
              </Button>}
          </div>
        </CardContent>
      ...
      {result && <Card className="max-w-3xl mx-auto dark:bg-gray-800 bg-white dark:border-gray-700 border-gray-200">
          <CardHeader className="flex flex-row items-center space-x-2">
      ...
      <Card className="max-w-3xl mx-auto dark:bg-gray-800 bg-white dark:border-gray-700 border-gray-200">
        ...
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-3 gap-4">
            ...
            desc: "Input the amount of calories you want to convert"
          }, {
            step: 2,
            title: "Select Activity Level",
            desc: "Choose your current activity level"
          }, {
            step: 3,
            title: "Get the Result",
            desc: "Click 'Calculate' to see the kg equivalent"
          }].map(item => <div key={item.step} className="text-center space-y-2 p-4 dark:bg-gray-700 bg-gray-100 rounded-lg">
      ...
      <section className="max-w-3xl mx-auto mt-8 dark:bg-gray-800 bg-white p-6 rounded-lg shadow-soft dark:text-gray-300 text-gray-900">
        ...
        }].map((example, index) => <Card key={index} className="dark:bg-gray-800 bg-white dark:border-gray-700 border-gray-200">
              <CardHeader>
      ...
      <section className="max-w-3xl mx-auto mt-8 dark:bg-gray-800 bg-white p-6 rounded-lg shadow-soft dark:text-gray-300 text-gray-900">
        ...
        <form onSubmit={handleFeedbackSubmit} className="space-y-4">
          <div>
            ...
            <Input id="name" value={feedback.name} onChange={e => setFeedback({
            ...feedback,
            name: e.target.value
          ...
          <div>
            ...
            <Input id="email" type="email" value={feedback.email} onChange={e => setFeedback({
            ...feedback,
          ...
          <div>
            ...
            <Input id="suggestions" value={feedback.suggestions} onChange={e => setFeedback({
            ...feedback,
