...
export default function AutoLoanAffordabilityCalculator() {
  ...
  const results = useMemo(() => {
    const { monthlyIncome, existingDebt, downPayment, loanTermYears, interestRate } = inputs;
    if (!isFinite(monthlyIncome) || !isFinite(existingDebt) || !isFinite(downPayment) || !isFinite(loanTermYears) || !isFinite(interestRate) || monthlyIncome <= 0 || loanTermYears <= 0) {
      return { maxAffordableCar: null, monthlyPayment: null };
    }
    const maxPayment = (monthlyIncome * 0.20) - existingDebt;
    const monthlyRate = interestRate / 100 / 12;
    const numPayments = loanTermYears * 12;
    const loanAmount = maxPayment > 0
      ? (maxPayment * (1 - Math.pow(1 + monthlyRate, -numPayments))) / monthlyRate
      : 0;
    const maxAffordableCar = loanAmount + downPayment;
    const monthlyPayment = maxPayment;
    return { maxAffordableCar, monthlyPayment };
  }, [inputs]);
  ...
  return (
    <CalculatorUnifiedLayout
      title="Auto Loan Affordability Calculator"
      stickyTopPx={120}
      maxWidth={1200}
      gap={32}
      showTopBanner
        ...
        <div className="skn-editorial">
          <section className="mb-6">
            <p className="text-base leading-relaxed mb-4">
              Are you planning to buy a car but unsure how much you can afford? This Auto Loan Affordability Calculator helps you determine the maximum car price you should consider based on your income, existing debts, and desired loan terms.
            </p>
            ...
            <p className="text-base leading-relaxed">
              If you need to calculate monthly payments, try our <a href="/financial/auto-loan-calculator" className="text-blue-600 hover:underline">Auto Loan Calculator</a> or explore our <a href="/financial/loan-calculator" className="text-blue-600 hover:underline">Loan Calculator</a> for more insights.
            </p>
          </section>
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">How much car can I afford?</h2>
            <p className="text-base leading-relaxed mb-4">
              When buying a car, setting a proper budget is crucial. The correct answer is based on precise calculations that take into account your monthly income, existing debt obligations, and the terms of the loan. 
            </p>
            <p className="text-base leading-relaxed mb-4">
            ...
            <p className="text-base leading-relaxed mb-4">
              Another rule: the value of the car shouldn't exceed 40% of your annual income. If you earn $40,000/year, aim for a car under $16,000.
            </p>
          </section>
          <section className="mb-8">
          ...
          <section className="mb-8">
            ...
            <div className="space-y-6">
              ...
              <div className="border-l-4 border-blue-500 pl-4">
                ...
                <p className="text-sm">
                  <strong>Result:</strong> Maximum affordable car: ~$25,000. Monthly payment: $520.
                </p>
              </div>
            </div>
          </section>
          <section className="mb-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-base leading-relaxed">
                  Put down 20%, finance for a maximum of 4 years, and keep expenses under 10% of your income.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold mb-2">How does my credit score affect my loan?</h3>
                <p className="text-base leading-relaxed">
                  A higher credit score can lower your interest rate, making your loan more affordable. Lenders typically offer better terms to borrowers with scores above 700.
                </p>
              </div>
            </div>
          </section>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-lg dark:border-gray-800 dark:bg-gray-900">
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="reset" onClick={() => setInputs({ monthlyIncome: 5000, existingDebt: 500, downPayment: 3000, loanTermYears: 5, interestRate: 5 })}>Reset</Button>
            </div>
            <div className="space-y-3 pt-4">
              <div className="p-4 bg-primary/5 rounded-lg">
                <p className="text-sm text-muted-foreground mb-1">Maximum Affordable Car</p>
                <p className="text-3xl font-bold text-primary">{formatCurrency(results.maxAffordableCar)}</p>
              </div>
              <div className="p-4 bg-primary/5 rounded-lg">
