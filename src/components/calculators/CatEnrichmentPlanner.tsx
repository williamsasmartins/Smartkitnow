...
export default function EnvironmentalEnrichmentPlannerPerRoom() {
  return (
    <div className="max-w-3xl mx-auto prose prose-neutral dark:prose-invert">
      <h1 className="mb-2">Environmental Enrichment Planner (per room)</h1>
      <p className="text-sm opacity-80">Category: pets · Subcategory: cats</p>

      <div className="mt-6 p-4 border rounded-xl">
        <h2>Calculator UI</h2>
        <p>This is a scaffold stub for <code>cat-enrichment-planner</code>. Replace with your real UI.</p>
