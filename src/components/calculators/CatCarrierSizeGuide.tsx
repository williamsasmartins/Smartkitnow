...
export default function CatCarrierSizeFitGuide() {
  return (
    <div className="max-w-3xl mx-auto prose prose-neutral dark:prose-invert">
      <h1 className="mb-2">Cat Carrier Size &amp; Fit Guide</h1>
      <p className="text-sm opacity-80">Category: pets · Subcategory: cats</p>

      <div className="mt-6 p-4 border rounded-xl">
        <h2>Calculator UI</h2>
        <p>This is a scaffold stub for <code>cat-carrier-size</code>. Replace with your real UI.</p>
