...
export default function LightBulbCostPerYear() {
  return (
    <div className="max-w-3xl mx-auto prose prose-neutral dark:prose-invert">
      <h1 className="mb-2">Light Bulb Cost per Year</h1>
      <p className="text-sm opacity-80">Category: everyday · Subcategory: home</p>

      <div className="mt-6 p-4 border rounded-xl">
        <h2>Calculator UI</h2>
        <p>This is a scaffold stub for <code>light-bulb-cost-per-year</code>. Replace with your real UI.</p>
