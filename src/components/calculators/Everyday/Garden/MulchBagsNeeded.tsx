...
export default function MulchCoverageBagsNeeded() {
  return (
    <div className="max-w-3xl mx-auto prose prose-neutral dark:prose-invert">
      <h1 className="mb-2">Mulch Coverage — Bags Needed</h1>
      <p className="text-sm opacity-80">Category: everyday · Subcategory: garden</p>

      <div className="mt-6 p-4 border rounded-xl">
        <h2>Calculator UI</h2>
        <p>This is a scaffold stub for <code>mulch-bags-needed</code>. Replace with your real UI.</p>
