  ...
  π ≈ 3.14159`}
      ...
      <section id="references" className="scroll-mt-32">
        ...
        <ul className="list-disc pl-5 space-y-4 text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <li>
            <a href="https://en.wikipedia.org/wiki/Special:Search?search=Electrical%20Reactance" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
          ...
          <li>
            <a href="https://www.khanacademy.org/search?page_search_query=Electrical%20Reactance" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
          ...
          <li>
            <a href="https://www.physicsclassroom.com/search?q=Electrical%20Reactance" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
