...
- Density converts between mass-based and volume-based units.`}
      ...
      <section id="references" className="scroll-mt-32">
        ...
        <ul className="list-disc pl-5 space-y-4 text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <li>
            <a href="https://en.wikipedia.org/wiki/Special:Search?search=Molality%20and%20Normality" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
              Molality and Normality - Wikipedia
            </a>
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              A comprehensive encyclopedia article providing an in-depth overview of Molality and Normality, including historical context, mathematical derivations, and key applications.
            </p>
          </li>
          <li>
            <a href="https://www.khanacademy.org/search?page_search_query=Molality%20and%20Normality" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
              Molality and Normality - Khan Academy
            </a>
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              Watch free educational video tutorials and complete interactive practice exercises on Molality and Normality at Khan Academy, perfect for visual learners.
            </p>
          </li>
          <li>
            <a href="https://chem.libretexts.org/Special:Search?query=Molality%20and%20Normality" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
              Molality and Normality - Chemistry LibreTexts
            </a>
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              Access open-access chemistry textbooks and rigorous academic articles explaining Molality and Normality in detail for students and researchers.
            </p>
          </li>
          <li>
            <a href="https://pubchem.ncbi.nlm.nih.gov/#query=Molality%20and%20Normality" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
              Molality and Normality - PubChem
            </a>
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              Search the PubChem database for chemical information, compound properties, and safety data related to Molality and Normality.
            </p>
          </li>
        </ul>
      </section>
