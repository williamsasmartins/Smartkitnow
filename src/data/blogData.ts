    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Multiplying by a moderate-activity factor of 1.55 gives his TDEE: 1,726 × 1.55 ≈ 2,675 calories a day. That's his maintenance number — eating 2,675 calories a day would hold his weight steady. Add the 389-calorie surplus from the goal above and his daily target becomes 2,675 + 389 = 3,064 calories a day. Hold that intake steady and the plan lands close to 10 pounds — though not exactly, because TDEE climbs as body weight climbs. At 175 lb, the same formula gives a TDEE of about 2,746 calories, roughly 71 higher than his starting 2,675, which quietly shrinks the surplus a flat 3,064 calories provides. Averaged across the full 90 days, that trims the real surplus to roughly 354 calories a day instead of 389, landing closer to 9 pounds gained than a full 10. Two ways to close that gap: recalculate TDEE around week 6 and raise intake by roughly 65 calories a day to make up the shortfall already banked, or simply start higher — about 3,100 calories a day instead of 3,064 — which builds the expected drift in up front and lands on the full 10 pounds over the same 90 days. (For the BMR and TDEE mechanics themselves, see our companion guide, Daily Calorie Needs Explained; the mirror-image question, cutting rather than adding calories, is covered in How Many Calories to Lose 10 Pounds in a Month.)",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "A calorie surplus only tells your body to store energy — it doesn't decide whether that energy becomes muscle or fat. Two inputs make the difference: resistance training that gives your muscles a reason to grow, and enough protein to supply the material for that growth. The International Society of Sports Nutrition's 2017 position stand on protein and exercise (Jäger et al.) puts that at 1.4 to 2.0 grams per kilogram of body weight per day for building and maintaining muscle — roughly 0.6 to 0.9 grams per pound, or about 105 to 150 grams for the 165-lb man in the example above. Skip either input and a surplus mostly just adds fat.",
          "The size of the surplus matters here too. In a 2013 trial published in the European Journal of Sport Science, Garthe and colleagues had elite strength athletes follow an 8-to-12-week weight-gain protocol on either a dietitian-planned calorie surplus or an ad libitum diet with no calorie guidance. The counselled group ate more and gained more total body weight than the ad libitum group, but the extra weight was disproportionately fat — the study found no meaningful lean-mass advantage for the larger, deliberate surplus over the smaller, self-selected one, and the authors' own conclusion was that a large surplus in a weight-gain plan should be approached carefully because of the fat gain it produces. That's real-world evidence for keeping a surplus modest: past a certain point, extra calories tend to become fat rather than muscle. A widely used coaching heuristic for lean-bulk pace reflects the same idea — 0.25 to 0.5 percent of body weight a week, or for a 165-lb lifter, roughly 0.4 to 0.8 lb a week (about 1.8 to 3.6 lb a month). The 389-calorie plan above targets 0.78 lb a week, the fast end of that range. If the scale climbs faster than about 1 lb a week with no strength gains to show for it, the surplus is bigger than muscle growth can use, and more of it is likely landing as fat.",
        ],
      },
    ],
    faqs: [
