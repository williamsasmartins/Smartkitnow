  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "A calorie surplus only tells your body to store energy — it doesn't decide whether that energy becomes muscle or fat. Two inputs make the difference: resistance training that gives your muscles a reason to grow, and enough protein to supply the material for that growth. The International Society of Sports Nutrition's position stand puts that at 1.4 to 2.0 grams per kilogram of body weight per day for building and maintaining muscle — roughly 0.6 to 0.9 grams per pound, or about 105 to 150 grams for the 165-lb man in the example above. Skip either input and a surplus mostly just adds fat.",
          "The size of the surplus matters here too. In a 2013 trial published in the European Journal of Sport Science, Garthe and colleagues put elite strength athletes on a counselled surplus of about 500 calories a day and compared them with athletes eating ad libitum with no calorie guidance; the counselled group gained more body mass and more of it as lean mass, while the ad libitum group gained weight but essentially no measurable lean mass. The takeaway is that a deliberate, tracked surplus builds more muscle than eating extra by feel. Separately, a widely used coaching heuristic for lean-bulk pace is 0.25 to 0.5 percent of body weight a week — for a 165-lb lifter, roughly 0.4 to 0.8 lb a week, or about 1.8 to 3.6 lb a month. The 389-calorie plan above lands at 0.78 lb a week, the fast end of that range. If the scale climbs faster than about 1 lb a week with no strength gains to show for it, the surplus is bigger than muscle growth can use, and more of it is likely landing as fat.",
        ],
      },
    ],
    faqs: [
