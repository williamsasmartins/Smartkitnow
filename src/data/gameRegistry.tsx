...
const TicTacToePrime = React.lazy(() => import("../components/games/board/TicTacToePrime"));
const NeonSnakeGame = React.lazy(() => import("../components/games/NeonSnakeGame"));
const SpaceInvadersGame = React.lazy(() => import("../components/games/SpaceInvadersGame"));
const AstroBreakoutGame = React.lazy(() => import("../components/games/AstroBreakoutGame"));
const NeonPaddleGame = React.lazy(() => import("../components/games/NeonPaddleGame"));
const AsteroidDriftGame = React.lazy(() => import("../components/games/AsteroidDriftGame"));
const PinballNeonGame = React.lazy(() => import("../components/games/PinballNeonGame"));
const BubbleShooterGame = React.lazy(() => import("../components/games/BubbleShooterGame"));
const BrickDashGame = React.lazy(() => import("../components/games/BrickDashGame"));
const SudokuZenGame = React.lazy(() => import("../components/games/SudokuZenGame"));
const WordleUnlimitedGame = React.lazy(() => import("../components/games/WordleUnlimitedGame"));
const TankBattleArenaGame = React.lazy(() => import("../components/games/TankBattleArenaGame"));
const PacRunnerGame = React.lazy(() => import("../components/games/PacRunnerGame"));
// import CrossyStreetGame from "../components/games/CrossyStreetGame";
// --- New fully-implemented games ---
const TetrisBlocksGame = React.lazy(() => import("../components/games/TetrisBlocksGame"));
const Connect4ProGame = React.lazy(() => import("../components/games/Connect4ProGame"));
const MinesweeperProGame = React.lazy(() => import("../components/games/MinesweeperProGame"));
const HangmanExtremeGame = React.lazy(() => import("../components/games/HangmanExtremeGame"));
const TypingRacerGame = React.lazy(() => import("../components/games/TypingRacerGame"));
const DinoRunGame = React.lazy(() => import("../components/games/DinoRunGame"));
const Game2048Classic = React.lazy(() => import("../components/games/Game2048Classic"));
const SimonSaysGame = React.lazy(() => import("../components/games/SimonSaysGame"));
const SnakeClassicGame = React.lazy(() => import("../components/games/SnakeClassicGame"));
const MemoryMatchGame = React.lazy(() => import("../components/games/MemoryMatchGame"));
const WaterSortGame = React.lazy(() => import("../components/games/WaterSortGame"));
const MentalMathGymGame = React.lazy(() => import("../components/games/MentalMathGymGame"));
const PianoTilesGame = React.lazy(() => import("../components/games/PianoTilesGame"));
const WordSearchProGame = React.lazy(() => import("../components/games/WordSearchProGame"));
const TwentyFourGame = React.lazy(() => import("../components/games/TwentyFourGame"));
const GeometryDashGame = React.lazy(() => import("../components/games/GeometryDashGame"));
const SubwaySurferLiteGame = React.lazy(() => import("../components/games/SubwaySurferLiteGame"));
const JigsawExplorerGame = React.lazy(() => import("../components/games/JigsawExplorerGame"));
const TangramMasterGame = React.lazy(() => import("../components/games/TangramMasterGame"));
const BlockPuzzleJewelGame = React.lazy(() => import("../components/games/BlockPuzzleJewelGame"));
const DifferencesFinderGame = React.lazy(() => import("../components/games/DifferencesFinderGame"));
const RubiksCube3x3Game = React.lazy(() => import("../components/games/RubiksCube3x3Game"));
const ChessMasterAIGame = React.lazy(() => import("../components/games/ChessMasterAIGame"));
const CrosswordDailyGame = React.lazy(() => import("../components/games/CrosswordDailyGame"));
const CosmicDashGame = React.lazy(() => import("../components/games/CosmicDashGame"));
const TempleEscapeGame = React.lazy(() => import("../components/games/TempleEscapeGame"));
const HexaPuzzleGame = React.lazy(() => import("../components/games/HexaPuzzleGame"));
const SpeedCuberTimerGame = React.lazy(() => import("../components/games/SpeedCuberTimerGame"));
const CubeSolverAIGame = React.lazy(() => import("../components/games/CubeSolverAIGame"));
const ScrabbleSoloGame = React.lazy(() => import("../components/games/ScrabbleSoloGame"));
const MathBlasterGame = React.lazy(() => import("../components/games/MathBlasterGame"));
const BackgammonLiveGame = React.lazy(() => import("../components/games/BackgammonLiveGame"));
const BaccaratRoyaleGame = React.lazy(() => import("../components/games/BaccaratRoyaleGame"));
const SpiderSolitaireGame = React.lazy(() => import("../components/games/SpiderSolitaireGame"));
const CandyBurstGame = React.lazy(() => import("../components/games/CandyBurstGame"));
const DrumKitProGame = React.lazy(() => import("../components/games/DrumKitProGame"));
const BasketballHoopsGame = React.lazy(() => import("../components/games/BasketballHoopsGame"));
const PipeConnectGame = React.lazy(() => import("../components/games/PipeConnectGame"));
const FractionPizzaGame = React.lazy(() => import("../components/games/FractionPizzaGame"));
const CheckersOnlineGame = React.lazy(() => import("../components/games/CheckersOnlineGame"));
const LudoPartyGame = React.lazy(() => import("../components/games/LudoPartyGame"));
const SolitaireKlondikeGame = React.lazy(() => import("../components/games/SolitaireKlondikeGame"));
const UnoFriendsGame = React.lazy(() => import("../components/games/UnoFriendsGame"));
const JewelHunterGame = React.lazy(() => import("../components/games/JewelHunterGame"));
const FruitSplashGame = React.lazy(() => import("../components/games/FruitSplashGame"));
const ZumaTumbleGame = React.lazy(() => import("../components/games/ZumaTumbleGame"));
const MusicRacerGame = React.lazy(() => import("../components/games/MusicRacerGame"));
const BeatSaberWebGame = React.lazy(() => import("../components/games/BeatSaberWebGame"));
const PacMazeGame = React.lazy(() => import("../components/games/PacMazeGame"));
const BallRollMazeGame = React.lazy(() => import("../components/games/BallRollMazeGame"));
const ScaryMazeGame = React.lazy(() => import("../components/games/ScaryMazeGame"));
const PenaltyShootoutGame = React.lazy(() => import("../components/games/PenaltyShootoutGame"));
const TableTennisProGame = React.lazy(() => import("../components/games/TableTennisProGame"));
const MazeRunner3DGame = React.lazy(() => import("../components/games/MazeRunner3DGame"));
const EightBallPoolGame = React.lazy(() => import("../components/games/EightBallPoolGame"));
const ArcheryMasterGame = React.lazy(() => import("../components/games/ArcheryMasterGame"));
const MinesweeperXPGame = React.lazy(() => import("../components/games/MinesweeperXPGame"));
const PinballClassicGame = React.lazy(() => import("../components/games/PinballClassicGame"));
const BreakoutRetroGame = React.lazy(() => import("../components/games/BreakoutRetroGame"));
const NinjaRoofRunnerGame = React.lazy(() => import("../components/games/NinjaRoofRunnerGame"));
