      ...
      subCategories: [
        {
          ...
          icon: "fa-solid fa-bolt",
          calculators: [
            { key: "amp-hours-to-kwh", name: "Amp-Hours (Ah) to Kilowatt-Hours (kWh) Conversion Calculator" },
            { key: "amp-hours-to-wh", name: "Amp-Hours (Ah) to Watt-Hours (Wh) Conversion Calculator" },
            { key: "amps-to-horsepower", name: "Amps to Horsepower Calculator" },
            { key: "amps-to-kva", name: "Amps to Kilovolt-Amps (kVA) Conversion Calculator" },
            { key: "amps-to-kw", name: "Amps to Kilowatts (kW) Conversion Calculator" },
            { key: "amps-to-va", name: "Amps to Volt-Amps (VA) Conversion Calculator" },
            { key: "amps-to-volts", name: "Amps to Volts Conversion Calculator" },
            { key: "amps-to-watts", name: "Amps to Watts Conversion Calculator" },
            { key: "capacitance-to-charge", name: "Capacitance to Charge Conversion Calculator" },
            { key: "horsepower-to-amps", name: "Horsepower to Amps Calculator" },
            { key: "horsepower-to-kva", name: "Horsepower to Kilovolt-Amps (kVA) Conversion Calculator" },
            { key: "joules-to-volts", name: "Joules to Volts Conversion Calculator" },
            { key: "joules-to-watts", name: "Joules to Watts Conversion Calculator" },
            { key: "kva-to-amps", name: "Kilovolt-Amps (kVA) to Amps Conversion Calculator" },
            { key: "kva-to-horsepower", name: "Kilovolt-Amps (kVA) to Horsepower Conversion Calculator" },
            { key: "kva-to-kw", name: "Kilovolt-Amps (kVA) to Kilowatts (kW) Conversion Calculator" },
            { key: "kva-to-va", name: "Kilovolt-Amps (kVA) to Volt-Amps (VA) Conversion Calculator" },
            { key: "kva-to-watts", name: "Kilovolt-Amps (kVA) to Watts Conversion Calculator" },
            { key: "kwh-to-ah", name: "Kilowatt-Hours (kWh) to Amp-Hours (Ah) Conversion Calculator" },
            { key: "kwh-to-kw", name: "Kilowatt-Hours (kWh) to Kilowatts (kW) Conversion Calculator" },
            { key: "kwh-to-watts", name: "Kilowatt-Hours (kWh) to Watts Conversion Calculator" },
            { key: "kw-to-amps", name: "Kilowatts (kW) to Amps Conversion Calculator" },
            { key: "kw-to-kva", name: "Kilowatts (kW) to Kilovolt-Amps (kVA) Conversion Calculator" },
            { key: "kw-to-kwh", name: "Kilowatts (kW) to Kilowatt-Hours (kWh) Conversion Calculator" },
            { key: "kw-to-va", name: "Kilowatts (kW) to Volt-Amps (VA) Conversion Calculator" },
            { key: "mah-to-wh", name: "Milliamp-Hours (mAh) to Watt-Hours (Wh) Conversion Calculator" },
            { key: "va-to-amps", name: "Volt-amps (VA) to Amps Conversion Calculator" },
            { key: "va-to-kva", name: "Volt-Amps (VA) to Kilovolt-Amps (kVA) Conversion Calculator" },
            { key: "va-to-kw", name: "Volt-amps (VA) to Kilowatts (kW) Conversion Calculator" },
            { key: "volts-to-amps", name: "Volts to Amps Conversion Calculator" },
            { key: "volts-to-joules", name: "Volts to Joules Conversion Calculator" },
            { key: "volts-to-watts", name: "Volts to Watts Conversion Calculator" },
            { key: "wh-to-ah", name: "Watt-Hours (Wh) to Amp-Hours (Ah) Conversion Calculator" },
            { key: "wh-to-mah", name: "Watt-Hours (Wh) to Milliamp-Hours (mAh) Conversion Calculator" },
            { key: "watts-to-amps", name: "Watts to Amps Conversion Calculator" },
            { key: "watts-to-joules", name: "Watts to Joules Conversion Calculator" },
            { key: "watts-to-kva", name: "Watts to Kilovolt-Amps (kVA) Conversion Calculator" },
            { key: "watts-to-kwh", name: "Watts to Kilowatt-Hours (kWh) Conversion Calculator" },
        ...
        },
        {
          ...
          calculators: [
            { key: "electricity-cost-2025", name: "2025 Electricity Cost Calculator" },
            { key: "lighting-energy-cost-2025", name: "2025 Lighting Energy Cost Calculator" },
            { key: "capacitance", name: "Capacitance Calculator" },
            { key: "coulombs-law-charge", name: "Coulomb's Law Charge Calculator" },
            { key: "current", name: "Current Calculator" },
            { key: "led-resistor", name: "LED Resistor Calculator" },
            { key: "ohms-law", name: "Ohm's Law Calculator" },
            { key: "parallel-plate-capacitance", name: "Parallel Plate Capacitance Calculator" },
            { key: "parallel-resistor", name: "Parallel Resistor Calculator" },
            { key: "peak-voltage", name: "Peak Voltage Calculator" },
            { key: "peak-to-peak-voltage", name: "Peak-to-Peak Voltage Calculator" },
            { key: "power-factor", name: "Power Factor Calculator" },
            { key: "resistance", name: "Resistance Calculator" },
            { key: "resistor-capacitor-circuit", name: "Resistor Capacitor Circuit Calculator" },
            { key: "rlc-impedance", name: "RLC Impedance Calculator" },
            { key: "rms-voltage", name: "RMS Voltage Calculator" },
            { key: "series-parallel-capacitor", name: "Series and Parallel Capacitor Calculator" },
            { key: "series-resistor", name: "Series Resistor Calculator" },
            { key: "voltage", name: "Voltage Calculator" },
            { key: "voltage-divider", name: "Voltage Divider Calculator" },
            { key: "voltage-drop", name: "Voltage Drop Calculator" },
            { key: "wattage", name: "Wattage Calculator" },
            { key: "wire-ampacity", name: "Wire Ampacity Calculator" },
