  ...
  const subCategories = [
    ...
    },
    {
      ...
      calculators: [
        ...
        { key: "apr-to-apy", name: "APR to APY Calculator" },
        { key: "apy", name: "APY Calculator" },
        { key: "cd", name: "CD Calculator" },
        { key: "cd-ladder", name: "CD Ladder Calculator" },
        { key: "compound-interest", name: "Compound Interest Calculator" },
        { key: "credit-card-interest", name: "Credit Card Interest Calculator" },
        { key: "credit-card-payoff", name: "Credit Card Payoff Calculator" },
        { key: "daily-compound-interest", name: "Daily Compound Interest Calculator" },
        { key: "ear", name: "EAR Calculator" },
        { key: "future-value", name: "Future Value Calculator" },
        { key: "interest", name: "Interest Calculator" },
        { key: "interest-rate", name: "Interest Rate Calculator" },
        { key: "loan-interest", name: "Loan Interest Calculator" },
        { key: "loan-payment", name: "Loan Payment Calculator" },
        { key: "loan-payoff", name: "Loan Payoff Calculator" },
        { key: "present-value", name: "Present Value Calculator" },
        { key: "rule-of-72", name: "Rule of 72 Calculator" },
        { key: "simple-interest", name: "Simple Interest Calculator" },
        { key: "student-loan", name: "Student Loan Calculator" },
        { key: "student-loan-payoff", name: "Student Loan Payoff Calculator" },
        { key: "time-value-money", name: "Time Value of Money Calculator" }
      ]
    },
    {
      ...
      calculators: [
        ...
        { key: "cash-on-cash-return", name: "Cash on Cash Return Calculator" },
        { key: "gross-rent-multiplier", name: "Gross Rent Multiplier Calculator" },
        { key: "ltv", name: "LTV Calculator" },
        { key: "mortgage-payoff", name: "Mortgage Payoff Calculator" },
        { key: "net-effective-rent", name: "Net Effective Rent Calculator" },
        { key: "net-operating-income", name: "Net Operating Income Calculator" },
        { key: "price-per-square-foot", name: "Price Per Square Foot Calculator" },
        { key: "property-management-cost", name: "Property Management Cost Calculator" },
        { key: "prorated-rent", name: "Prorated Rent Calculator" },
        { key: "real-estate-commission", name: "Real Estate Commission Calculator" },
        { key: "rent", name: "Rent Calculator" },
        { key: "rental-property", name: "Rental Property Calculator" },
        { key: "rental-property-depreciation", name: "Rental Property Depreciation Calculator" }
      ]
    },
    {
