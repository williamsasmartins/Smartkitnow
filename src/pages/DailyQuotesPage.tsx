...
export default function DailyQuotesPage() {
  ...
  const currentItems = useMemo(() => {
    ...
    // @ts-ignore - Ignorando erro de tipagem no acesso dinâmico por enquanto
    const itemsList = MOCK_DATA.content[selectedCategory as keyof typeof MOCK_DATA.content];
    if (!itemsList) return [];
